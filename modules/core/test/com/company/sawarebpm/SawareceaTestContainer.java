...
public class SawareceaTestContainer extends TestContainer {

    public SawareceaTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "com/company/sawarebpm/app.properties",
    ...
    public static class Common extends SawareceaTestContainer {

        public static final SawareceaTestContainer.Common INSTANCE = new SawareceaTestContainer.Common();
